...
class MinerConfig(BaseModel):
    ...
    @classmethod
    def from_vnish(cls, web_settings: dict, web_presets: list[dict], perf_summary: dict) -> "MinerConfig":
        ...
        return cls(
            ...
            mining_mode=MiningModeConfig.from_vnish(web_settings, web_presets, perf_summary),
        )
