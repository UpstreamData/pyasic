...
from .proto.braiins.bos import ApiVersionRequest, ApiVersionServiceStub
...
class BOSerWebAPI(BaseWebAPI):
        ...
        try:
            async with Channel(self.ip, self.port) as c:
                ...
                try:
                    return cast(
                        dict[str, Any],
                        (await endpoint(message, metadata=metadata)).to_pydict(),
                    )
    ...
    async def set_locate_device_status(self, enable: bool) -> dict[str, Any]:
        return await self.send_command(
    ...
    async def get_locate_device_status(self) -> dict[str, Any]:
        return await self.send_command(
    ...
    async def set_password(self, password: str | None = None) -> dict[str, Any]:
        return await self.send_command(
            "set_password",
    ...
    async def get_cooling_state(self) -> dict[str, Any]:
        return await self.send_command(
    ...
    async def get_tuner_state(self) -> dict[str, Any]:
        return await self.send_command(
            "get_tuner_state", message=GetTunerStateRequest(), privileged=True
        )

    async def list_target_profiles(self) -> dict[str, Any]:
        return await self.send_command(
    ...
    async def get_active_performance_mode(self) -> dict[str, Any]:
        return await self.send_command(
    ...
    async def get_pool_groups(self) -> dict[str, Any]:
        return await self.send_command(
            "get_pool_groups", message=GetPoolGroupsRequest(), privileged=True
        )

    async def get_miner_configuration(self) -> dict[str, Any]:
        return await self.send_command(
    ...
    async def get_license_state(self) -> dict[str, Any]:
        return await self.send_command(
    ...
    async def get_miner_details(self) -> dict[str, Any]:
        return await self.send_command(
    ...
    async def get_hashboards(self) -> dict[str, Any]:
        return await self.send_command(
            "get_hashboards", message=GetHashboardsRequest(), privileged=True
        )

    async def get_support_archive(self) -> dict[str, Any]:
        return await self.send_command(
