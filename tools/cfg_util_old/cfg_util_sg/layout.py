...
layout = [
    ...
    [
        sg.Text("IP List File:", size=(13, 1)),
    ...
    [
            ...
            [
                    ...
                    sg.Column(
                        [
                            [
                                ...
                                sg.Button(
                                    "RESTART BACKEND", key="restart_miner_backend"
                                ),
                                sg.Button(
                                    "SEND SSH COMMAND",
                                    key="send_miner_ssh_command_window",
                                ),
                            ],
                            [
                                sg.Text("HR Total: ", pad=(0, 0)),
                                sg.Text("", key="hr_total"),
                            ],
                        ]
                    )
                ],
                [
                    sg.Table(
                        ...
                        key="ip_table",
                        col_widths=[15, 16, 15, 12, 12, 31, 11],
        ...
        sg.Column(
            [
                [
                    sg.Text("Config"),
                    sg.Button("IMPORT", key="import_config"),
