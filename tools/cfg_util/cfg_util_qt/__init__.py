...
FAULT_LIGHT = b""
...
# sg.ChangeLookAndFeel("BrightColors")
...
def get_config_layout():
    config_layout = [
        ...
        [
            ...
            sg.Button("OPEN IN WEB", key="scan_web"),
            sg.Push(),
            sg.Checkbox("Append IP to Username"),
        ],
        [
            sg.Table(
                values=[],
...
layout = [
    [
        sg.Text("", size=(10, 1)),
        sg.ProgressBar(max_value=100, size_px=(0, 20), expand_x=True),
        sg.Text("0%", size=(10, 1)),
    ],
    [
        sg.TabGroup(
