...
layout = [
    [sg.Text("", key="status", size=(9, 1)), sg.ProgressBar(1000, key="progress", size=(95, 20), orientation='h'),
     sg.Text("", key="progress_percent", size=(9, 1))],
    [sg.Text("", size=(100, 1))],
    [sg.Text('Network IP:', size=(9, 1)), sg.InputText(key='miner_network', do_not_clear=True, size=(123, 1)),
     sg.Button('Scan', key='scan')],
    [sg.Text('IP List File:', size=(9, 1)), sg.Input(key="file_iplist", do_not_clear=True, size=(123, 1)),
     sg.FileBrowse(),
     sg.Button('Import', key="import_iplist"), sg.Button('Export', key="export_iplist")],
    [sg.Text('Config File:', size=(9, 1)), sg.Input(key="file_config", do_not_clear=True, size=(123, 1)),
     sg.FileBrowse(),
